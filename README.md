...
	Even better than good error messages is a careful design which prevents a problem from occurring in the first place. 
  ...
  • When a searched class has a time conflict with an already scheduled class, Coursicle visibly fades the color of the new class so users know not to schedule it in. This prevents users from potentially creating time conflicts in their schedule and avoids creating a future error or problem. No issues or improvements are needed for this.
